...
public class MinimaxPlayer implements IPlayer, IAuto {
    ...
    /**
     * Constructor que defineix la profunditat fixa de cerca.
     * @param depth Profunditat màxima de l'arbre Minimax.
     */
    ...
    // =====================================================
    /**
     * Calcula el següent moviment utilitzant Minimax a profunditat fixa.
     *
     ...
     * @param maximizing Torn del jugador maximitzador.
     * @return Resultat amb valor i moviment.
     */
    ...
    // =====================================================
    /**
     * Genera la llista de moviments possibles.
     */
     ...
     * Comparteix la mateixa lògica de pesos que l'IDSMinimaxPlayer.
     *
     * @param s Estat del joc.
     * @return Puntuació de l'estat.
     */
    ...
    /**
     * Calcula el guany de captura d'un moviment.
     */
    ...
    /**
     * Compta grups de fitxes connectades.
     */
