...
public class IDSMinimaxPlayer implements IPlayer, IAuto {
     ...
     *
     * @param milliseconds Temps límit disponible per calcular el moviment.
     */
     ...
     *
     * @return Cadena amb el nom identificatiu.
     */
    @Override
    ...
    // =====================================================
    /**
     * Mètode principal que decideix el millor moviment possible dins del temps
     * límit. Executa una cerca IDS (Iterative Deepening Search), incrementant
     * la profunditat (1, 2, 3...) fins que s'esgota el temps assignat.
     *
     * @param gs L'estat actual del joc.
     * @return El millor moviment trobat (PlayerMove).
     */
    @Override
    ...
    /**
     * Executa la cerca del millor moviment per a una profunditat específica.
     * Gestiona la seqüència de moviments en cas de torns múltiples
     * (encadenaments).
     *
     * @param root Estat inicial per a aquesta cerca.
     * @param depth Profunditat màxima a explorar.
     * @return Llista de punts que formen la jugada completa.
     */
     ...
     * @param alpha Valor Alpha (millor opció garantida per al maximitzador).
     * @param beta Valor Beta (millor opció garantida per al minimitzador).
     * @param maximizing Booleà que indica si és el torn del nostre jugador.
     * @return Objecte Result amb la valoració heurística i el millor moviment.
     */
    ...
    // =====================================================
    /**
     * Calcula un hash únic de 64 bits per a l'estat del tauler (Zobrist Hashing
     * simplificat).
     *
     * @param s L'estat del joc.
     * @return Valor hash identificatiu de la configuració de peces.
     */
    ...
    /**
     * Entrada per a la Taula de Transposició.
     */
    ...
    /**
     * Genera tots els moviments vàlids disponibles per a l'estat actual.
     *
     * @param s Estat del joc.
     * @return Llista de punts on es pot col·locar una fitxa.
     */
    ...
    // =====================================================
    /**
     * Funció d'Avaluació Heurística. Calcula una puntuació numèrica per a
     * l'estat del tauler basant-se en diversos factors estratègics: mida dels
     * grups, captures, mobilitat i nombre de fitxes.
     *
     * @param s Estat del joc a avaluar.
     * @return Puntuació (positiva favorable al jugador propi, negativa al
     * rival).
     */
    ...
    /**
     * Simula un moviment i calcula quantes fitxes enemigues serien capturades.
     */
    ...
    /**
     * Compta el nombre de grups desconnectats que té un jugador.
     */
    ...
    /**
     * Auxiliar per marcar tots els nodes d'un grup com a visitats (BFS).
     */
    ...
    /**
     * Compta quants moviments legals té disponible un jugador.
     */
    ...
    /**
     * Verifica si s'ha superat el temps límit. Si és així, llança una excepció
     * per aturar la cerca.
     */
    ...
    /**
     * Classe interna per retornar el resultat de la cerca Alpha-Beta.
     */
